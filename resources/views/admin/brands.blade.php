                                    ...
                                    <table id="price-rule-table" class="table-hover bulk-action-context expanded">
                                        ...
                                        @foreach($brands as $brand)
                                            <tr>
                                                <td class="select">
                                                    <div class="next-input-wrapper">
                                                        <label class="next-label helper--visually-hidden next-label--switch" for="category_ids_{{$brand->id}}">Chọn {{$brand->brandName}}</label>
                                                        <input type="checkbox"
                                                               name="category_ids_{{$brand->id}}"
                                                               id="category_ids_{{$brand->id}}"
                                                               value="{{$brand->id}}"
                                                ...
                                                <td class="category name">
                                                    <div class="ui-stack ui-stack--wrap">
                                                        <div class="ui-stack-item">
                                                            <a href="">
                                                                <span data-toggle="tooltip" data-placement="right" data-original-title="{{$brand->brandName}}">{{$brand->brandName}}</span>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </td>
